...
object OmniTermWidgetUpdater {
        ...
        withContext(Dispatchers.IO) {
            appWidgetIds.forEach { appWidgetId ->
                publishIfCurrent(appWidgetId) {
                    ...
                    // Deprecated since API 35; its replacement needs minSdk 31, above this app's 24.
    ...
    private fun createRemoteViews(
        ...
        return RemoteViews(context.packageName, R.layout.omniterm_widget).apply {
            ...
            // Deprecated since API 35; RemoteCollectionItems needs minSdk 31, above this app's 24.
