...
void main() {
  ...
  group('NavigationController history', () {
    ...
    test('tapping the active destination is a no-op', () {
      final nav = NavigationController()..navigateTo(Screen.tools);
      var notifications = 0;
      ...
      expect(nav.screenHistory, [Screen.servers, Screen.tools]);
