...
class _TerminalKeyBarState extends State<TerminalKeyBar> {
  ...
  List<Widget> _caps(ShellViewModel vm) => switch (_layer) {
        KeyBarLayer.symbol => [
            ...
            _cap('SYM', active: true, activeColor: OmniColors.purple, onTap: () => _show(KeyBarLayer.nav)),
            _cap('FN', active: true, activeColor: OmniColors.amber, onTap: () => _show(KeyBarLayer.function)),
          ],
        KeyBarLayer.function => [
            ...
            _cap('SYM', active: true, activeColor: OmniColors.purple, onTap: () => _show(KeyBarLayer.symbol)),
