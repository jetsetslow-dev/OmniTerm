...
- Quick scripts, alert rules, Wake-on-LAN targets, backup jobs, app settings, and recent metric history.
...
Users can delete hosts, credentials, keys, scripts, alerts, Wake-on-LAN targets, and backup jobs inside the app. Uninstalling the app removes its local database and settings from the device.
